export const traitDescriptions: Map<String, string> = new Map(
  Object.entries({
    ...
    Daredevil: 'is reckless and daring, is confident and active and unaffected by stress',
    ...
    Diffident: 'has no confidence in their habilities and decisions',
    ...
    Neurotic: 'is neurotic, has higher sensitivity to sadness, anger and stress',
