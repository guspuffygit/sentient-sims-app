...
const lumpinouRpoTraitDescription: Record<string, TraitMapping> = {
  Lumpinou_RPO_Core_Trait_NoPopUpChoiceWindows: {
    name: 'Lumpinou_RPO_Core_Trait_NoPopUpChoiceWindows',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_GLOBAL_ReturnTrait: {
    name: 'Lumpinou_RPO_GLOBAL_ReturnTrait',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_GLOBAL_Trait_HasHadChild_ForInteractions: {
    name: 'Lumpinou_RPO_GLOBAL_Trait_HasHadChild_ForInteractions',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_GLOBAL_Trait_HasHadPreg_ForInteractions: {
    name: 'Lumpinou_RPO_GLOBAL_Trait_HasHadPreg_ForInteractions',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_GLOBAL_Trait_Hidden_Adopted: {
    name: 'Lumpinou_RPO_GLOBAL_Trait_Hidden_Adopted',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_GLOBAL_Trait_ModEnabler: {
    name: 'Lumpinou_RPO_GLOBAL_Trait_ModEnabler',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M02_F_Commodity_IndivFerti_Cyclical_Period_Trait_DoesntGet: {
    name: 'Lumpinou_RPO_M02_F_Commodity_IndivFerti_Cyclical_Period_Trait_DoesntGet',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M02_F_Commodity_IndivFerti_Cyclical_Period_Trait_Gets: {
    name: 'Lumpinou_RPO_M02_F_Commodity_IndivFerti_Cyclical_Period_Trait_Gets',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M02_F_Commodity_IndivFerti_Cyclical_Period_Trait_Never: {
    name: 'Lumpinou_RPO_M02_F_Commodity_IndivFerti_Cyclical_Period_Trait_Never',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M02_F_Trait_HadFertilitySurgery: {
    name: 'Lumpinou_RPO_M02_F_Trait_HadFertilitySurgery',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M02_P_Trait_BirthControl_MedicalAny: {
    name: 'Lumpinou_RPO_M02_P_Trait_BirthControl_MedicalAny',
    ignored: false,
    description: 'accepted Pregnancy',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M02_P_Trait_BirthControl_Pill: {
    name: 'Lumpinou_RPO_M02_P_Trait_BirthControl_Pill',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M02_P_Trait_Infertile: {
    name: 'Lumpinou_RPO_M02_P_Trait_Infertile',
    ignored: false,
    description: 'Infertile',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M02_P_Trait_WHProtected_Global_DEPRECATED: {
    name: 'Lumpinou_RPO_M02_P_Trait_WHProtected_Global_DEPRECATED',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M1_Accept_Trait_AcceptdPreg_ForOnePreg: {
    name: 'Lumpinou_RPO_M1_Accept_Trait_AcceptdPreg_ForOnePreg',
    ignored: true,
    description: 'Accepted Pregnancy',
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M1_Misc_ChangeOpportunities_Trait_ExcludedFromChanges: {
    name: 'Lumpinou_RPO_M1_Misc_ChangeOpportunities_Trait_ExcludedFromChanges',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M1_Offspring_Trait_WantsBoyishChild: {
    name: 'Lumpinou_RPO_M1_Offspring_Trait_WantsBoyishChild',
    ignored: false,
    description: 'Would like to have a Son / Boyish Child',
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M1_Offspring_Trait_WantsGirlyChild: {
    name: 'Lumpinou_RPO_M1_Offspring_Trait_WantsGirlyChild',
    ignored: false,
    description: 'Would like to have a Daughter / Girly Child',
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M1_Offspring_Trait_WantsNoPrefReOFfspringGender: {
    name: 'Lumpinou_RPO_M1_Offspring_Trait_WantsNoPrefReOFfspringGender',
    ignored: false,
    description: 'Would Like Either or Both',
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M1_Trait_CanImpreg_DoesNotWantChildren: {
    name: 'Lumpinou_RPO_M1_Trait_CanImpreg_DoesNotWantChildren',
    ignored: false,
    description: 'Does Not Want a Child Right Now',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M1_Trait_CanImpreg_IndiffToGetChildren: {
    name: 'Lumpinou_RPO_M1_Trait_CanImpreg_IndiffToGetChildren',
    ignored: false,
    description: 'Neutral about Having Children',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M1_Trait_CanImpreg_WantsChildren: {
    name: 'Lumpinou_RPO_M1_Trait_CanImpreg_WantsChildren',
    ignored: false,
    description: 'Would be Happy to Have a Child',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M1_Trait_DoesNotWantChildren: {
    name: 'Lumpinou_RPO_M1_Trait_DoesNotWantChildren',
    ignored: false,
    description: 'Does Not Want a Child Right Now',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M1_Trait_IndiffToGetChildren: {
    name: 'Lumpinou_RPO_M1_Trait_IndiffToGetChildren',
    ignored: false,
    description: 'Neutral about Having Children',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M1_Trait_NotOkWithPreg: {
    name: 'Lumpinou_RPO_M1_Trait_NotOkWithPreg',
    ignored: false,
    description: 'Not Ok with Being Pregnant',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M1_Trait_OkWithPreg: {
    name: 'Lumpinou_RPO_M1_Trait_OkWithPreg',
    ignored: false,
    description: 'Ok with Being Pregnant',
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M1_Trait_WantsChildren: {
    name: 'Lumpinou_RPO_M1_Trait_WantsChildren',
    ignored: false,
    description: 'Would Be Happy to Have a Child',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M10_AltGrd_Trait_HasWithSeparatedParentsAndCustodyArr: {
    name: 'Lumpinou_RPO_M10_AltGrd_Trait_HasWithSeparatedParentsAndCustodyArr',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M10_MEGA_LOOT_If_Get_Back_Together_testFix_RemovalOperationalMarker: {
    name: 'Lumpinou_RPO_M10_MEGA_LOOT_If_Get_Back_Together_testFix_RemovalOperationalMarker',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M10_Trait_ArrangedCustody: {
    name: 'Lumpinou_RPO_M10_Trait_ArrangedCustody',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M10_Trait_HasSeparation_BrokenUpOrDivorced: {
    name: 'Lumpinou_RPO_M10_Trait_HasSeparation_BrokenUpOrDivorced',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M12_TraitDoesNotHavePregnancySideEffects: {
    name: 'Lumpinou_RPO_M12_TraitDoesNotHavePregnancySideEffects',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M13_object_unrstone_Trait_StoredSimStatus: {
    name: 'Lumpinou_RPO_M13_object_unrstone_Trait_StoredSimStatus',
    ignored: false,
    class: 'Trait',
    trait_type: TraitType.GHOST,
  },
  Lumpinou_RPO_M13_object_unrstone_Trait_StoredSimWasNamed: {
    name: 'Lumpinou_RPO_M13_object_unrstone_Trait_StoredSimWasNamed',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M13_Trait_HasHadMiscarriage: {
    name: 'Lumpinou_RPO_M13_Trait_HasHadMiscarriage',
    ignored: false,
    description: 'Had a Miscarriage',
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M14_DiscovSetting_Trait_NoPregnancyDiscovery: {
    name: 'Lumpinou_RPO_M14_DiscovSetting_Trait_NoPregnancyDiscovery',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M15_Trait_AlwaysFaithful: {
    name: 'Lumpinou_RPO_M15_Trait_AlwaysFaithful',
    ignored: false,
    description: 'Always Faithful',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M15_Trait_Celibate: {
    name: 'Lumpinou_RPO_M15_Trait_Celibate',
    ignored: false,
    description: 'chooses to abstain from sex. They will not offer to have sex, and will decline if propositioned',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M16_SupInt_FindMatches_Trait_DontMatchMeAgain: {
    name: 'Lumpinou_RPO_M16_SupInt_FindMatches_Trait_DontMatchMeAgain',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M16_SupInt_FindMatches_Trait_GeneratedForDate: {
    name: 'Lumpinou_RPO_M16_SupInt_FindMatches_Trait_GeneratedForDate',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M17_Trait_DoesNotParticipateInPreferences: {
    name: 'Lumpinou_RPO_M17_Trait_DoesNotParticipateInPreferences',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M17_Trait_ParticipatesInPreferences: {
    name: 'Lumpinou_RPO_M17_Trait_ParticipatesInPreferences',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M19_ExtraAspects_NotOkWithKissing: {
    name: 'Lumpinou_RPO_M19_ExtraAspects_NotOkWithKissing',
    ignored: false,
    description: 'is not interested in any romantic kissing interaction, and will reject them.',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M19_ExtraAspects_NotOkWithRomanticTouching: {
    name: 'Lumpinou_RPO_M19_ExtraAspects_NotOkWithRomanticTouching',
    ignored: false,
    description:
      "does not want to 'embrace', 'hold hands', 'caress cheek', and any other non-kissing, non-sexual physical romantic interactions, and will reject these interactions.",
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M19_ExtraAspects_WooHooTrauma: {
    name: 'Lumpinou_RPO_M19_ExtraAspects_WooHooTrauma',
    ignored: false,
    description:
      'has a history of sexual Trauma, they might reject offers to have sex a bit more often than others, and experience occasional dissociation.',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M19_GLOBAL_Trait: {
    name: 'Lumpinou_RPO_M19_GLOBAL_Trait',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M19_Styles_Trait_Has: {
    name: 'Lumpinou_RPO_M19_Styles_Trait_Has',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M20_Trait_DNA_OnFile: {
    name: 'Lumpinou_RPO_M20_Trait_DNA_OnFile',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M20_Trait_Processed_NotOnFile: {
    name: 'Lumpinou_RPO_M20_Trait_Processed_NotOnFile',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_DamagedKidneys: {
    name: 'Lumpinou_RPO_M3_Trait_DamagedKidneys',
    ignored: false,
    description:
      'has damaged kidneys. They need to use the bathroom more often than others and take medication. They may also experience symptoms such as nausea and fatigue. The condition should improve over the next few weeks and finally disappear',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M3_Trait_HasAIDS: {
    name: 'Lumpinou_RPO_M3_Trait_HasAIDS',
    ignored: false,
    description:
      'has AIDS. At this stage, the HIV virus has severely compromised their immune system. They must take their medication and go to the doctor regularly.  So long as they take their medication, they will keep their viral levels low and drastically reduce the possibility of transmitting the disease to WooHoo partners. Antiretroviral therapy may have some side effects, especially early on',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M3_Trait_HasChlamidyaAsymptomatic: {
    name: 'Lumpinou_RPO_M3_Trait_HasChlamidyaAsymptomatic',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_HasChlamidyaAsymptomaticRevealed: {
    name: 'Lumpinou_RPO_M3_Trait_HasChlamidyaAsymptomaticRevealed',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_HasChlamidyaSymptomatic: {
    name: 'Lumpinou_RPO_M3_Trait_HasChlamidyaSymptomatic',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_HasGonorrheaAsymptomatic: {
    name: 'Lumpinou_RPO_M3_Trait_HasGonorrheaAsymptomatic',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_HasGonorrheaAsymptomaticRevealed: {
    name: 'Lumpinou_RPO_M3_Trait_HasGonorrheaAsymptomaticRevealed',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_HasGonorrheaSymptomatic: {
    name: 'Lumpinou_RPO_M3_Trait_HasGonorrheaSymptomatic',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_HasHerpes_Revealed: {
    name: 'Lumpinou_RPO_M3_Trait_HasHerpes_Revealed',
    ignored: false,
    description:
      "will suffer occasional outbreaks of the Downstairs Herpes. Having sex during an outbreak is very likely to contaminate one's partner, so they need to be careful.",
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M3_Trait_HasHerpesPerm: {
    name: 'Lumpinou_RPO_M3_Trait_HasHerpesPerm',
    ignored: false,
    description: 'Has Downstairs Herpes',
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_HasHIV: {
    name: 'Lumpinou_RPO_M3_Trait_HasHIV',
    ignored: false,
    description:
      'has HIV. They must take medication for it not to harm their immune system any further. So long as they take their medication, they will keep their viral levels low and drastically reduce the possibility of transmitting the disease to sexual partners. Antiretroviral therapy may have some side effects, especially early on.-->',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M3_Trait_HasTrichomoniasis: {
    name: 'Lumpinou_RPO_M3_Trait_HasTrichomoniasis',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_HasTrichomoniasisAsymptomaticRevealed: {
    name: 'Lumpinou_RPO_M3_Trait_HasTrichomoniasisAsymptomaticRevealed',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_HasTrichomoniasisAsymptomaticUntilTreated: {
    name: 'Lumpinou_RPO_M3_Trait_HasTrichomoniasisAsymptomaticUntilTreated',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_HasYeast: {
    name: 'Lumpinou_RPO_M3_Trait_HasYeast',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_Hidden_CaughtWTDorIssue: {
    name: 'Lumpinou_RPO_M3_Trait_Hidden_CaughtWTDorIssue',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_Trait_InterstitialCystitis: {
    name: 'Lumpinou_RPO_M3_Trait_InterstitialCystitis',
    ignored: false,
    description:
      'Interstitial Cystitis is generally a permanent condition, and is generally acquired after a UTI. It causes symptoms almost identical to those of a UTI, except there is no infection. No cure exists. This condition will occasionally get outbreaks which will cause UTI-like symptoms.',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M3_Trait_OnHivPreventative: {
    name: 'Lumpinou_RPO_M3_Trait_OnHivPreventative',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M3_TraitHadWTDautoAssigned: {
    name: 'Lumpinou_RPO_M3_TraitHadWTDautoAssigned',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M4_Trait_FatherOfChildDiscovered: {
    name: 'Lumpinou_RPO_M4_Trait_FatherOfChildDiscovered',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M5_TraitHadTeenPregnancy: {
    name: 'Lumpinou_RPO_M5_TraitHadTeenPregnancy',
    ignored: false,
    description: 'had a teenage pregnancy',
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M6_Trait_HasSeparation_NotBrokenUpOrDivorced: {
    name: 'Lumpinou_RPO_M6_Trait_HasSeparation_NotBrokenUpOrDivorced',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M7_Trait_AlwaysJealous: {
    name: 'Lumpinou_RPO_M7_Trait_AlwaysJealous',
    ignored: false,
    description: 'is jealous over any romantic interaction their partner has with others',
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M7_Trait_JealousOnlyForWooHoo: {
    name: 'Lumpinou_RPO_M7_Trait_JealousOnlyForWooHoo',
    ignored: false,
    description: 'only jealous when their romantic partner sleeps with others',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M7_Trait_NeverJealous: {
    name: 'Lumpinou_RPO_M7_Trait_NeverJealous',
    ignored: false,
    description: 'never jealous of any romantic interaction their parter has with others',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M7_Trait_NotJealousForFlirting: {
    name: 'Lumpinou_RPO_M7_Trait_NotJealousForFlirting',
    ignored: false,
    description: 'never jealous of any flirting their parter does with others',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M7_Trait_NotJealousForKissing: {
    name: 'Lumpinou_RPO_M7_Trait_NotJealousForKissing',
    ignored: false,
    description: 'never jealous of any kissing their parter has with others',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M7_Trait_NotJealousForWooHoo: {
    name: 'Lumpinou_RPO_M7_Trait_NotJealousForWooHoo',
    ignored: false,
    description: 'never jealous of any sex their parter has with others',
    class: 'Trait',
    trait_type: TraitType.GAMEPLAY,
  },
  Lumpinou_RPO_M8_AI_Trait_ArtificalInseminatedPregnancy: {
    name: 'Lumpinou_RPO_M8_AI_Trait_ArtificalInseminatedPregnancy',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M8_AI_Trait_ConceivedByArtificalInsemination: {
    name: 'Lumpinou_RPO_M8_AI_Trait_ConceivedByArtificalInsemination',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M8_PS_Trait_ConceivedByPlayerSurrogatePregnancy: {
    name: 'Lumpinou_RPO_M8_PS_Trait_ConceivedByPlayerSurrogatePregnancy',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M8_PS_Trait_MemberOfAgencyOfSurrogates: {
    name: 'Lumpinou_RPO_M8_PS_Trait_MemberOfAgencyOfSurrogates',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M8_PS_Trait_PlayerSurrogatePregnancy_ForOnePregnancy: {
    name: 'Lumpinou_RPO_M8_PS_Trait_PlayerSurrogatePregnancy_ForOnePregnancy',
    ignored: true,
    description: 'Trait_AcceptedPregnancy_ForOnePregnancy',
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M8_S_Trait_ConceivedBySurrogatePregnancy: {
    name: 'Lumpinou_RPO_M8_S_Trait_ConceivedBySurrogatePregnancy',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M8_S_Trait_IsNPCSurrogate: {
    name: 'Lumpinou_RPO_M8_S_Trait_IsNPCSurrogate',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
  Lumpinou_RPO_M9_AC_trait_Hidden_IsChildForAdoption: {
    name: 'Lumpinou_RPO_M9_AC_trait_Hidden_IsChildForAdoption',
    ignored: true,
    class: 'Trait',
    trait_type: TraitType.HIDDEN,
  },
