...
> = new Map(
  Object.entries({
    ...
    sentimentBit_Actor_FuriousAt_Target_ST_generic: {
      ...
      description:
        "Just the sight of {actor.1} gets on {actor.0}'s nerves these days.",
    },
    ...
    sentimentBit_Actor_CloseTo_Target_LT_generic: {
      ...
      description:
        '{actor.0} has a powerful bond with {actor.1} that is a source of strength and comfort.',
    },
    ...
    sentimentBit_Actor_AdoringTo_Target_ST_generic: {
      ...
      description:
        '{actor.0} just wants the best for {actor.1} and thinks {actor.1} is so wonderful!',
    },
    ...
    sentimentBit_Actor_BitterAt_Target_LT_cheating: {
      ...
      description:
        '{actor.0} is bitter at {actor.1} because {actor.1} cheated on {actor.0}.',
    },
    sentimentBit_Actor_BitterAt_Target_ST_fight: {
      name: 'sentimentBit_Actor_BitterAt_Target_ST_fight', // Grudging after a Fight
      description:
        '{actor.0} and {actor.1} are bitter at each other after a fight.',
    },
    sentimentBit_Actor_CloseTo_Target_ST_adoption: {
      ...
      description:
        '{actor.0} feels close to a recent adopted addition to the family, {actor.1}.',
    },
    ...
    sentimentBit_Actor_HurtBy_Target_ST_saddened: {
      ...
      description:
        '{actor.0} is sad and hurt about their relationship with {actor.1}.',
    },
    ...
    sentimentBit_Actor_AdoringTo_Target_LT_lifesaver: {
      ...
      description:
        '{actor.1} literally saved {actor.0} from the clutches of death.',
    },
    sentimentBit_Actor_CloseTo_Target_ST_nearDeath: {
      name: 'sentimentBit_Actor_CloseTo_Target_ST_nearDeath',
      description:
        "{actor.1} almost dying has endeared to {actor.0} after {actor.0} saved {actor.1}'s life.", // Huh
    },
    ...
    'friendship-bff': {
      name: 'friendship-bff',
      description:
        '{actor.0} and {actor.1} are the best of friends with a nearly unbreakable bond.',
    },
    'friendship-bff_Evil': {
      name: 'friendship-bff_Evil',
      description:
        '{actor.0} and {actor.1} are evil best friends and henchmen to each other.',
    },
    'friendship-despised': {
    ...
    'friendship-friend_Evil': {
      ...
      description:
        '{actor.0} and {actor.1} are friends pretending to be enemies.',
    },
    ...
    'romantic-Broken_Up': {
      ...
      description:
        '{actor.0} and {actor.1} are broken up and exes to each other.',
    },
    'romantic-Broken_Up_Engaged': {
      name: 'romantic-Broken_Up_Engaged',
      description:
        '{actor.0} and {actor.1} were once engaged but broke it off before the wedding.',
    },
    'romantic-Despised_Ex': {
      name: 'romantic-Despised_Ex',
      description:
        '{actor.0} and {actor.1} were once in a relationship, but now despise each other.',
    },
    'romantic-Divorced': {
      name: 'romantic-Divorced',
      description:
        '{actor.0} and {actor.1} were once married but are now divorced.',
    },
    'romantic-Engaged': {
    ...
    'romantic-Frustrated_Ex': {
      ...
      description:
        '{actor.0} and {actor.1} are exes and frusted with each other.',
    },
    ...
    romantic_Target_GotColdFeetOf_Actor: {
      ...
      description:
        '{actor.0} and got cold feet at the alar and left {actor.1} at the altar.',
    },
    romantic_Target_LeftTheAlterOf_Actor: {
      name: 'romantic_Target_LeftTheAlterOf_Actor',
      description:
        '{actor.1} left {actor.0} at the altar, leaving {actor.0} with utter humiliation.',
    },
    'romantic-Married': {
    ...
    RomanticCombo_EnemiesWithBenefits: {
      ...
      description:
        '{actor.1} and {actor.0} hate each other, but are friends with benefits.',
    },
    ...
    RomanticCombo_HotAndCold: {
      ...
      description:
        '{actor.1} and {actor.0} have a hot and cold romantic relationship.',
    },
    RomanticCombo_ItsAwkward: {
      name: 'RomanticCombo_ItsAwkward',
      description:
        '{actor.1} and {actor.0} have an awkward romantic relationship.',
    },
    RomanticCombo_ItsVeryAwkward: {
      name: 'RomanticCombo_ItsVeryAwkward',
      description:
        '{actor.1} and {actor.0} have a very awkward romantic relationship.',
    },
    RomanticCombo_ItsComplicated: {
      name: 'RomanticCombo_ItsComplicated',
      description:
        '{actor.1} and {actor.0} have a complicated romantic relationship.',
    },
    RomanticCombo_ItsVeryComplicated: {
      name: 'RomanticCombo_ItsVeryComplicated',
      description:
        '{actor.1} and {actor.0} have a veru complicated romantic relationship.',
    },
    ...
    RomanticCombo_RomanticInterest: {
      ...
      description:
        'Its too early to tell, but {actor.1} and {actor.0} could have a budding romantic interest.',
    },
    ...
    RomanticCombo_TerribleMatch: {
      ...
      description:
        '{actor.1} and {actor.0} dislike each other and are a terrible romantic match.',
    },
    RomanticCombo_TotalOpposites: {
      name: 'RomanticCombo_TotalOpposites',
      description:
        '{actor.1} and {actor.0} are complete opposites in a romantic relationship.',
    },
    ...
    relbit_AdoptedBySim: {
      ...
      description:
        '{actor.1} is the adopted {actor.1.father/mother} of {actor.0}.',
    },
    relbit_AdoptedSim: {
      name: 'relbit_AdoptedSim',
      description:
        '{actor.1} is the adopted {actor.0.father/mother} of {actor.1}.',
    },
    sentimentBit_Actor_EnamoredBy_Target_LT_Loyal_SecondChance: {
      ...
      description:
        '{actor.1} and {actor.0} are taking a second chance at their relationship.',
    },
    sentimentBit_Actor_CloseTo_Target_LT_Loyal_RegainedTrust: {
      name: 'sentimentBit_Actor_CloseTo_Target_LT_Loyal_RegainedTrust',
      description:
        "{actor.1} worked hard to regain {actor.0}'s trust in their relationship.",
    },
    ShortTerm_RecentFirstKiss: {
      name: 'ShortTerm_RecentFirstKiss',
      description:
        '{actor.1} and {actor.0} just shared their first kiss recently.',
    },
    RomanticCombo_Disliked: {
      name: 'RomanticCombo_Disliked',
      description:
        '{actor.1} and {actor.0} dislike each other in their relationship.',
    },
    ...
    RomanticCombo_JustFriends: {
      ...
      description:
        '{actor.1} and {actor.0} are just friends, and are not romantically involved.',
    },
    ...
    RomanticCombo_Despised: {
      ...
      description:
        '{actor.1} and {actor.0} despise each other in their romantic relationship.',
    },
    ...
    toddler_notParent_Actor_IsCareGiverOf_Target: {
      ...
      description:
        '{actor.0} is not a parent, but is a caregiver to {actor.1}.',
    },
    ...
    bit_NoLongerFriends: {
      ...
      description:
        '{actor.0} and {actor.1} were once friends but are no longer friends.',
    },
    ...
    sentimentBit_Actor_HurtBy_Target_ST_attentioJealousy: {
      ...
      description:
        '{actor.0} is feeling overshadowed by their sibling, {actor.1}.',
    },
    multi_unit_neighbor: {
    ...
    SpecialBits_DeclaredArchEnemy: {
      ...
      description:
        '{actor.0} and {actor.1} have declared each other arch enemies.',
    },
    ...
    romantic_Target_LeavedAlterOf_Actor: {
      ...
      description:
        '{actor.1} had left {actor.0} at the altar while they were getting married.',
    },
    ...
    'romantic-HasBeenUnfaithful': {
      ...
      description:
        '{actor.1} and {actor.0} have been unfaithful to each other.',
    },
    neighbor: {
      name: 'neighbor',
    ...
    'romantic-Promised': {
      ...
      description:
        '{actor.1} and {actor.0} have promised each other they will be a romantic couple forever.',
    },
    ...
    ShortTerm_RecentNegativeSocial: {
      ...
      description:
        '{actor.1} and {actor.0} recently had a negative social interaction.',
    },
    relationshipBit_Matchmaking_AddedOnMatchmakingApp: {
      name: 'relationshipBit_Matchmaking_AddedOnMatchmakingApp',
      description:
        '{actor.1} and {actor.0} added each other and met on a matchmaking app.',
    },
  }),
);
